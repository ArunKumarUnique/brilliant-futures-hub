...
const config: TenantConfig = {
  ...
  media: {
    ...
    photos: [
      { src: '/tenants/brilliant-tutorials/gallery-1.jpeg', caption: 'Parent-Teacher Meeting' },
      { src: '/tenants/brilliant-tutorials/faculty-profile.jpeg', caption: 'Mr. Karthik Ananthoju' },
      { src: '/tenants/brilliant-tutorials/gallery-2.jpeg', caption: 'Certificate Distribution' },
      { src: '/tenants/brilliant-tutorials/gallery-3.jpeg', caption: 'Classroom Teaching' },
    ],
    achievements: [
