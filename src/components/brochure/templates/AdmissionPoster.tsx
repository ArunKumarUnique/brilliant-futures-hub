...
const AdmissionPoster = ({ config, content }: Props) => {
  ...
  return (
    ...
    >
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 600 800" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Large arc top-right */}
        ...
        <rect x="60" y="350" width="8" height="8" rx="1" fill="white" opacity="0.06" transform="rotate(45 64 354)" />
        <rect x="520" y="600" width="6" height="6" rx="1" fill="white" opacity="0.05" transform="rotate(20 523 603)" />
      </svg>
      ...
      {logoPath && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <img
            ...
            style={{ opacity: 0.06, filter: 'grayscale(100%) brightness(2)' }}
              ...
              <li key={i} className="flex items-center gap-2.5 text-sm" style={{ color: `hsl(${config.theme.primaryForeground})` }}>
                <span
                  ...
                  style={{
                    background: `hsl(${config.theme.secondary})`,
                    color: `hsl(${config.theme.secondaryForeground})`,
                    boxShadow: `0 1px 4px hsl(${config.theme.secondary} / 0.4)`,
                  }}
                >
                  ✓
                </span>
